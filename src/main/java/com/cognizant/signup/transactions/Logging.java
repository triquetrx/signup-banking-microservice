package com.cognizant.signup.transactions;
...
public class Logging {
	...
	@Pointcut("within(com.cognizant.signup.service..*)"
			+ " || within(com.cognizant.signup.controller..*)"
			+ " || within(com.cognizant.signup..*)")
